...
O projeto SGE-RBAC foi desenvolvido em colaboração pela dupla de estudantes, do 3 ano de Engenharia de Software:
    • Abreu Martinho Pedro (Desenvolvedor A — Frontend & UI | GitHub: AbreuPedro-Dev):
        ◦ Responsabilidades: Desenvolvimento da SPA (public/index.html), interface visual da matriz de permissões RBAC (public/js/app.js), estilos Glassmorphic e temas (public/css/style.css).
        ◦ Branch de Trabalho: feature/frontend-rbac-ui
    • Paulo José Massingue Júnior (Desenvolvedor B — Backend & API | GitHub: Paulo-Junior97):
        ◦ Responsabilidades: Implementação do servidor Node.js/Express (server.js), endpoints da API REST (/api/auth, /api/expedientes, /api/auditoria), segurança JWT, encriptação bcrypt e persistência de dados.
...
cd SGE-RBAC-Sistema-de-Gestao-de-Expedientes
    ...
    3. Iniciar a aplicação:
       ...
       npm run dev
    4. Aceder à aplicação no navegador: Abra o seu navegador web e aceda ao endereço: http://localhost:3000
...
Entrega do Trabalho em Grupo
    ...
    • Link do Repositório GitHub: https://github.com/AbreuPedro-Dev/SGE-RBAC-Sistema-de-Gestao-de-Expedientes
